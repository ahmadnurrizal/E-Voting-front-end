         ...
         <div class="card">
            ...
            <div class="content">
               <form @submit.prevent="handlePoll">
                  ...
                  <input type="text" name="title" placeholder="type your title here.." v-model="title" /><br />
                  <div class="deskripsi">
                     <label for="desc">Description (optional)</label><br />
                     <textarea id="description" placeholder="type your description here.." v-model="description" /><br />
                  </div>
                  <ul>
                     <li v-for="(item, index) in arrInput" :key="item">
                        <div>
                           <label for="answer">Answer Option</label><br />
                           <input type="text" @focus="addEvent" :id="item" v-model="option[index].option" />
                  ...
                  <div class="settings">
                     ...
                     ><br />
                     <input type="date" style="display: none; width: 320px" required id="deadline" v-model="deadline" />
